...
class ThrapistUserChatCard extends StatelessWidget {
  final RelationEntity freinds;
  const ThrapistUserChatCard({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    final profile = freinds.userProfile! as TherapistEntity;
              ...
              Flexible(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      "Specialty : ${toFirstLetterUpper(profile.specialty ??'-')}",
                      style: TextStyle(
                        color: AppColor.grey3,
                        fontSize: 14,
                      ),
                    ...
                    Text(
                      "Affilication : ${toFirstLetterUpper(profile.affiliation ?? '-')}",
                      style: TextStyle(
                        color: AppColor.grey3,
                        fontSize: 14,
                      ),
